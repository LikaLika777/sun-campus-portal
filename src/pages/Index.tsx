...
export default function Index() {
  ...
  return (
    <div>
      ...
      <section className="relative min-h-[520px] sm:min-h-[560px] md:min-h-[620px] flex items-center justify-center overflow-hidden -mt-16" aria-labelledby="hero-heading">
        {/* Background image */}
        <img
          src={heroBanner}
          alt=""
